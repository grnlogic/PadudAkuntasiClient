...
import { usePiutangForm } from "../hooks/usePiutangForm";

interface PiutangFormComponentProps {
  onSubmit: (data: any) => Promise<void>;
  onCancel?: () => void;
}

export default function PiutangFormComponent({
  onSubmit,
  onCancel,
}: PiutangFormComponentProps) {
  const {
    formData,
    errors,
    isSubmitting,
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            required
          >
            {TRANSACTION_TYPES.PIUTANG.map((type) => (
